...
function get_location_tickets_url(p_location_id) {
	var the_url = apis.get_base_url()+apis.urls.tickets
...
function get_location_ticket_id_url(p_args) {
	...
	var the_url = apis.get_base_url()+apis.urls.ticket_id;
...
module.exports = function() {
	...
	return {
		get_location_tickets_url: get_location_tickets_url,
		gen_ticket_args: gen_ticket_args,
		get_location_ticket_url: get_location_ticket_url,
