...
var get_base_location_url = function(p_location_id) {
	if(p_location_id==undefined) {
		throw new Error('no location_id');
	}
	return endpoint_url+'/'+api_version+'/'+'locations'+'/'+p_location_id;
}
...
module.exports = function() {
	return {
		...
		get_base_location_url: get_base_location_url,
		//...
		urls: urls,
		//...
