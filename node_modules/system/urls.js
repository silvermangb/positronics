...
var ticket_lo = {
		type : {'tickets':0,'ticket':0},
		tickets : get_location_tickets,
		ticket  : get_location_ticket_id,
		items : get_location_ticket_items,
		ticket_item_id : get_location_ticket_item_id,
		ticket_item_id_modifiers : get_location_ticket_item_id_modifiers,
		ticket_item_id_modifier_id : get_location_ticket_item_id_modifier_id,
}
var get_location_ticket = function(p_args) {
	f = ticket_lo[p_args['type']];
